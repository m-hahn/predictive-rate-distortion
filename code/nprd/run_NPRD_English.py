...
while True:
   ...
   command = map(str,["./python27", "nprd_words_PTB.py", language, languageCode, dropout_rate, emb_dim, rnn_dim, rnn_layers, lr_lm, model, input_dropoutRate, batchSize, input_noising, horizon, beta, flow_length, flowtype])
   print(" ".join(command))
