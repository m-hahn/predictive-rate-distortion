...
while True:
   ...
   subprocess.call(map(str,["./python27", "nprd_words_PTB.py", language, languageCode, dropout_rate, emb_dim, rnn_dim, rnn_layers, lr_lm, model, input_dropoutRate, batchSize, horizon, beta, flow_length, flowtype]))
