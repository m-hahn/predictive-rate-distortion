...
ggsave(plot, file="../figures/LDC95T8-words-nlogbeta-mem-fitted.pdf", device=cairo_pdf)
...
plot = plot + ylab("Rate")
plot = plot + theme(legend.position="none")
ggsave("../figures/LDC95T8-words-info-fitted.pdf", plot=plot, device=cairo_pdf) 
...
plot = plot + theme(legend.position="none")
ggsave("../figures/LDC95T8-words-nlogbeta-ee-fitted.pdf", plot=plot, device=cairo_pdf) 
