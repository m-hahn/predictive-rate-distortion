...
ggsave(plot, file="../figures/ar-words-nlogbeta-mem-fitted.pdf", device=cairo_pdf)
...
plot = plot + ylab("Rate")
plot = plot + theme(legend.position="none")
ggsave("../figures/ar-words-info-fitted.pdf", plot=plot, device=cairo_pdf) 
...
plot = plot + theme(legend.position="none")
ggsave("../figures/ar-words-nlogbeta-ee-fitted.pdf", plot=plot, device=cairo_pdf) 
