    ...
    data = read.csv("~/CS_SCR/results-en-upos-neuralflow_RECURSIVE.tsv", sep="\t")
    library(tidyr)
    library(dplyr)
    library(ggplot2)
data$Horizon = 15
...
plot = ggplot(data, aes(x=Memories, y=FutureSurp, group=model, color=model)) + geom_point()+ theme_classic() 


plot = ggplot(data, aes(x=Memories, y=avg16-FutureSurp, group=model, color=model)) + geom_point()+ theme_classic() 

data = data %>% mutate(EEE = (avg16-avg17) + 2*(avg17-avg18) + 3*(avg18-avg19))

plot = ggplot(data, aes(x=Memories, y=EEE, group=model, color=model)) + geom_point()+ theme_classic() 

plot = ggplot(data, aes(x=-log(Beta), y=FutureSurp, group=model, color=model)) + geom_point()+ theme_classic() 

plot = ggplot(data, aes(x=-log(Beta), y=Memories, group=model, color=model)) + geom_point()+ theme_classic() 

plot = ggplot(data, aes(x=-log(Beta), y=avg17, group=model, color=model)) + geom_point()+ theme_classic()
plot = ggplot(data, aes(x=-log(Beta), y=avg18-avg17, group=model, color=model)) + geom_point()+ theme_classic()
plot = ggplot(data, aes(x=-log(Beta), y=avg19-avg18, group=model, color=model)) + geom_point()+ theme_classic()

#plot = ggplot(data, aes(x=Memories, y=UpperBound, group=model, color=model)) + geom_point()+ theme_classic() 
...
plot = ggplot(data, aes(x=avg16, y=Memories,)) + geom_point()+ theme_classic() 
...
ggsave("figures/engish_RECURSIVE-info-fitted.pdf", plot=plot) 
...
plot = plot + theme(legend.position="none")
ggsave("figures/engish_RECURSIVE-nlogbeta-ee-fitted.pdf", plot=plot) 
...
plot = plot + ylab("Rate")
plot = plot + theme(legend.position="none")
ggsave("figures/engish_RECURSIVE-beta-mem-fitted.pdf", plot=plot)
...
plot = plot + ylab("Rate")
plot = plot + theme(legend.position="none")
ggsave("figures/engish_RECURSIVE-logbeta-mem-fitted.pdf", plot=plot) 
...
ggsave("figures/engish_RECURSIVE-nlogbeta-mem-fitted.pdf", plot=plot) 
...
plot = ggplot(data, aes(x=FutureSurp, y=Memories,)) + geom_point()+ theme_classic() 
...
plot = plot + ylab("Rate")
plot = plot + theme(legend.position="none")
ggsave("figures/engish_RECURSIVE-info.pdf", plot=plot) 
...
plot = plot + ylab("Rate")
plot = plot + theme(legend.position="none")
ggsave("figures/engish_RECURSIVE-beta-mem.pdf", plot=plot)
...
#ggsave("figures/engish_RECURSIVE-logbeta-mem.pdf", plot=plot)
...
plot = plot + xlab("log(1/Lambda)")
plot = plot + ylab("Rate")
ggsave("figures/engish_RECURSIVE-nlogbeta-mem.pdf", plot=plot)
...
#ggsave("figures/engish_RECURSIVE-logbeta-ee.pdf", plot=plot)
...
plot = plot + xlab("log(1/Lambda)")
plot = plot + ylab("Predictiveness")
ggsave("figures/engish_RECURSIVE-nlogbeta-ee.pdf", plot=plot)
