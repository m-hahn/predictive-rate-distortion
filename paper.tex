...
\title{Estimating Predictive Rate-Distortion via Neural Variational Inference} %Crosslinguistic Word Orders Trade Off Predictability and Memory Load}%  Word Order Minimizes  Across Languages
\author{Michael Hahn}
\date{2018}
...
%\includegraphics[width=0.45\textwidth]{cryptfig/even-beta-mem.pdf}
...
Comparing the two diagrams shows that NPRD effectively recovers the $\epsilon$-machine. % even though $Z$ is a multivariate Gaussian variable.
...
\begin{figure*}
\includegraphics[width=0.45\textwidth]{cryptfig/foo_pca_3_machine.png}
...
\begin{figure*}
%\includegraphics[width=0.45\textwidth]{cryptfig/repeat2-ee-mem.pdf}
...
%\includegraphics[width=0.45\textwidth]{cryptfig/english-beta-mem.pdf}
...
%\includegraphics[width=0.45\textwidth]{cryptfig/english-beta-mem-fitted.pdf}
...
\begin{figure*}
%\includegraphics[width=0.3\textwidth]{cryptfig/en-words-surp-mem.pdf}
%\includegraphics[width=0.3\textwidth]{cryptfig/en-words-16-mem.pdf}
\includegraphics[width=0.3\textwidth]{cryptfig/en-words-ee-mem.pdf}
%\includegraphics[width=0.3\textwidth]{cryptfig/en-words-beta-mem.pdf}
...
\begin{figure*}
%\includegraphics[width=0.3\textwidth]{cryptfig/ru-words-surp-mem.pdf}
%\includegraphics[width=0.3\textwidth]{cryptfig/ru-words-16-mem.pdf}
\includegraphics[width=0.3\textwidth]{cryptfig/ru-words-ee-mem.pdf}
%\includegraphics[width=0.3\textwidth]{cryptfig/ru-words-beta-mem.pdf}
