...
% TODO mention sam bowman's language VAE

% potentially cite https://arxiv.org/pdf/1609.05191.pdf
...
\begin{equation}\label{eq:bound}
	\min_{\phi, \psi, q} \left[\mathbb{E}_{\finitepast, \finitefuture}	\left[-	\mathbb{E}_{Z \sim \phi(\finitepast)}\left[\log P_\psi(\finitefuture | Z)\right] + \lambda \cdot \operatorname{D_{KL}} [ \infdivx{P_\phi(Z|\finitepast)}{q(Z)}\right]\right],
\end{equation} % should be P_\psi (X_{0...M}|z)? % done (mhahn)
...
- \mathbb{E}_{X_{\finitepast\finitefuture}}\left[\log P_\eta(\finitefuture) - P_\psi(\finitefuture | Z)\right]
\end{equation}
