...
\textbf{TODO talk more about bacteria, animals, language, ....}
...
%As OCE relies on counts of full past and future observation sequences,
...
Understanding the complexity of prediction in language holds promise to enabling a deeper understanding of the nature of language as a stochastic process (CITE Debowski).
Recently, \cite{dkebowski2018natural} has studied statistical properties beyond the entropy rate, such as the excess entropy.
\cite{koplenig2017statistical} shows a link between the information contained in word forms and word order and traditional linguistic notions of grammatical structure.



TODO also cite physicists on long-range correlations in text

The difficulty of prediction is another interesting aspect of language complexity:



In Psycholinguistics, the idea of a tradeoff between representing the past well and predicting the future accurately appears in \cite{futrell-noisy-context-2017}. Also Prediction Cost~\cite{gibson-linguistic-1998}
...
We study entirely within individual sentences.

One motivation for this is because we are ultimately interested in PRD as a model of memory in human sentence processing, formalizing psycholinguistic models \citep{gibson-linguistic-1998,futrell-noisy-context-2017} and linking to studies of the relation between information theory and grammar \citep{koplenig2017statistical}.
Another motivation is that, when directly estimating PRD, computational cost has to increase with the length of sequences considered.
We limit our computations to sequences of length 30, already improving over OCE by an order of magnitude.


Our work is related to studies of long-range correlations in text (CITE).



Long-range correlations in text have been a subject of study \citep{altmann2012origin,ebeling1995long,yang2016long,ebeling1994entropy,chen2018quantifying,schenkel1993long}
